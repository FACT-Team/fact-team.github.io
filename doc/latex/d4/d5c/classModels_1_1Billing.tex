...
get\-Filename Return the filename of billing (without extension) 
...
get\-Folder Return the directory of billing 
...
get\-Path Return the path of billing filename (without extension) 
